...
const Card: React.FC<CardProps> = ({
  ...
  return (
    <div className="card md:w-64 md:h-96 xs:w-56 p-6 flex flex-col shadow-card3 hover:shadow-card5 dark:hover:shadow-none  rounded-md overflow-hidden bg-grey dark:bg-lprimary cursor-pointer bg-[#fff]">
